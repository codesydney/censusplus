...
from . import employmentrate
from .database import get_db_employment

#app = Flask(__name__)

@employmentrate.route('/details', methods=['GET'])
def get_details():
    db = get_db_employment()
...
@employmentrate.route('/details/<string:SUBURB>', methods=['GET'])
